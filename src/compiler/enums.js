...
const InputType = {
    ...
    COLOR: 0x2000,
    /** Any array, excluding an array of values in the form [R, G, B] */
    ARRAY_NON_COLOR: 0x4000,
    /** Any array. Equal to COLOR | ARRAY_NON_COLOR */
    ARRAY: 0x6000,
    /** Any object. */
    OBJECT: 0x8000,
...
const InputOpcode = {
    ...
    JSON_OBJECT_CONTAINS_KEY: 'json.objectContainsKey',
